...
xcopy /Y /E /I "E:\SteamLibrary\steamapps\common\Arma 3\MPMissions" "C:\Users\%username%\Documents\GitHub\7th_Platoon_Irish_Guards\Server files\mpmissions\"
Xcopy /Y /E /I "C:\Users\%username%\Documents\GitHub\7th_Platoon_Irish_Guards\Server files" "E:\SteamLibrary\steamapps\common\Arma 3\"
pause
cls
